		<div class="tstk-footer-overlay"><div class="tstk-footer-overlay-inner"><div class="container"><div class="row"><div class="tstk-footer-overlay-left col-md-3"></div><div class="tstk-footer-overlay-right col-md-9"><div class="tstk-footer-contact-info"><div class="tstk-footer-contact-info-inner d-flex align-items-center"><i class="tstk-industrey-icon tstk-base-icon-time-call"></i><div class="tstk-footer-contact-info-wrap"><span class="tstk-label tstk-label-2">Hot Line</span>+91 9713014516</div></div></div><div class="tstk-footer-contact-info"><div class="tstk-footer-contact-info-inner d-flex align-items-center"><i class="tstk-industrey-icon tstk-base-icon-email"></i><div class="tstk-footer-contact-info-wrap"><span class="tstk-label tstk-label-2">E-mail Address</span><a href="mailto:shrikrishnarubberindustries@gmail.com">shrikrishnarubberindustries@gmail.com</a></div></div></div><div class="tstk-footer-contact-info"><div class="tstk-footer-contact-info-inner d-flex align-items-center"><i class="tstk-industrey-icon  tstk-base-icon-send"></i><div class="tstk-footer-contact-info-wrap"><span class="tstk-label tstk-label-2">Our Location</span>58, 59 Industrial Estate, Adhartal, Jabalpur</div></div></div></div></div></div></div></div>		<footer id="colophon" class="tstk-footer-section site-footer tstk-footer-style-2 tstk-text-color-white tstk-bg-color-secondarycolor tstk-footer-menu-yes tstk-footer-widget-yes">
  ...
  <h4>
 Sign up for industry alert,news &#38; Insights
  </h4>
...
</div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1779971820" /><input type="hidden" name="_mc4wp_form_id" value="12722" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form><!-- / Mailchimp for WordPress Plugin -->
</div>
